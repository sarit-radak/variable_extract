...
def write_to_excel(file_name, row_data):
    try:
        ...
        sheet.append(["Library", "Good Hits", "Wrong Num Hits", "Coords Bad", "Good Hits %", "Wrong Num Hits %", "Coords Bad %", "Timestamp"])
...
summary_file = "files/extraction_summary.xlsx" # summary of extraction success
...
good_fmt = f"{good:,}"
wrong_num_hits_fmt = f"{wrong_num_hits:,}"
coords_bad_fmt = f"{coords_bad:,}"
good_percent_fmt = f"{good_percent:,.2f}"  # Two decimal places
wrong_num_hits_percent_fmt = f"{wrong_num_hits_percent:,.2f}"
coords_bad_percent_fmt = f"{coords_bad_percent:,.2f}"

write_to_excel(summary_file, [library, good_fmt, wrong_num_hits_fmt, coords_bad_fmt, good_percent_fmt, wrong_num_hits_percent_fmt, coords_bad_percent_fmt, timestamp])
